		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsapktnavenavexample-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapktnavenavexample-display": {
								"semanticObject": "comsapktnavenavexample",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.kt.nave.navexample",
									"url": sap.ui.require.toUrl("com/sap/kt/nave/navexample")
								}
							}
						}
					}
